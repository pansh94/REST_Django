# TestAPIView
Django has 4 types of API test cases:
1. APISimpleTestCase
...
## 1.APITestCase
All test case classes implement the interface as Django's TestCase class. REST API can return custom data field that return serializer fields or through overriding the to_representation method.
```
